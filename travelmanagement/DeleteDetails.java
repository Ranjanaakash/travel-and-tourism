...
public class DeleteDetails extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            DBConnection conn = new DBConnection();
            conn.stmt.executeUpdate("delete from account where username = '"+username+"' ");
            conn.stmt.executeUpdate("delete from customer where username = '"+username+"' ");
            conn.stmt.executeUpdate("delete from bookpackage where username = '"+username+"' ");
            conn.stmt.executeUpdate("delete from bookhotel where username = '"+username+"' ");
